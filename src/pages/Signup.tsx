  ...
  return (
    <div className="auth-page">
      ...
      <div className="auth-container">
        ...
        <p className="auth-subtitle">Join Health Prediction to start your wellness journey</p>
            ...
            {password && (
              <div className="password-strength">
                <div className="strength-bars">
                  <div className={`strength-bar ${passwordStrength.strength >= 1 ? 'active weak' : ''}`}></div>
                  <div className={`strength-bar ${passwordStrength.strength >= 2 ? 'active medium' : ''}`}></div>
                  <div className={`strength-bar ${passwordStrength.strength >= 3 ? 'active strong' : ''}`}></div>
                </div>
