    ...
    <div className="devs-container">
      ...
      <div className="dev-grid">
        {developers.map((dev, index) => (
          <div key={index} className="dev-card" style={{ animationDelay: `${index * 0.1}s` }}>
            <div className="dev-photo" style={{ background: dev.gradient }}>
      ...
      <div className="contact-box">
        ...
        <div className="contact-items">
          ...
          <div className="contact-item">
            ...
            <span>healthprediction@example.com</span>
          </div>
        </div>
      </div>
    </div>
